...
const CustomHead = ({ attributes }) => {
  return (
    <Head>
      ...
      <script
        async
        src="https://www.googletagmanager.com/gtag/js?id=G-JXCL355W6T"
      ></script>
      <script
        dangerouslySetInnerHTML={{
          __html: `window.dataLayer = window.dataLayer || []; function gtag() { dataLayer.push(arguments); } gtag("js", new Date()); gtag("set", "developer_id.dZGVlNj", true); gtag("config", "G-JXCL355W6T");`
        }}
      />
    </Head>
  );
